...
cells=(
  ...
  "marker-only-guarded-wrapped|0|^true$"
  "unguarded-marker-only-wrapped|1|cannot convert a function to JSON"
  "unguarded-marker-only-bare|1|cannot convert a function to JSON"
  "path-guarded-wrapped|0|^true$"
  "unguarded-path-wrapped|1|path '/x' does not exist"
  "unguarded-path-bare|1|path '/x' does not exist"
  "nonstring-path-guarded-wrapped|0|^true$"
  "unguarded-nonstring-path-wrapped|1|cannot convert a function to JSON"
  "unguarded-nonstring-path-bare|1|cannot convert a function to JSON"
